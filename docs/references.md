...
- [Software Project Best Practices Checklist (kkovacs)](https://kkovacs.eu/software-project-best-practices-checklist/)
- [New Software Project Checklist (ardalis)](https://github.com/ardalis/new-software-project-checklist)
- [Software Development Checklist (Manifestly)](https://www.manifest.ly/use-cases/software-development/software-development-plan-checklist)
- [Software Development Checklist (Idea Maker)](https://ideamaker.agency/software-development-checklist/)
- [Code Style and Conventions Standards (CodingRules)](https://www.codingrules.ai/rules/code-style-and-conventions-standards-for-architecture)
...
- [OpenAI Cookbook: Guardrails Example](https://developers.openai.com/cookbook/examples/how_to_use_guardrails/)
